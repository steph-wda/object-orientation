...
favoriteThings.show = 'Golden Girls';
...
let cat1 = new Cat('Boots', 2, 'brown');
...
const wiz = new Wizard('Harry',16,'Mutiple');
wiz.castSpell();
...
let phone1 = new Phone('Samsung', 'Galaxy 8', 64, 'red', 250)
let phone2 = new Phone('Apple', 'iphone', 128, 'black', 1000)
let phone3 = new Phone('Google', 'Pixel', 128, 'pink', 800)
...
let myFirstVehicle = new Vehicle(4,'blue', 2500)
...
let myFirstMotorcycle = new Motorcycle(2, 'black', 158, 'honda', true);
...
*/
const myFirstBoat = new Boat(4, 'black', 2500, 'Betty Boop', 'speedboat', false);
